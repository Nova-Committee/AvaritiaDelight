...
public class ExtremeCookingPotCategory<T extends ExtremeCookingPotRecipe> implements IRecipeCategory<T> {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.tryBuild(AvaritiaDelight.MOD_ID, "textures/gui/jei/extreme_cooking_pot.png");
    ...
    public @NotNull Component getTitle() {
        return Component.translatable(ExtremeCookingPotRecipe.ID.toLanguageKey("jei.category"));
    }
    ...
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, ExtremeCookingPotRecipe recipe, @NotNull IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.OUTPUT, 168, 76).addItemStack(recipe.getResultItem(world.registryAccess()));
        builder.addSlot(RecipeIngredientRole.INPUT, 168, 99).addItemStack(recipe.getOutputContainer());
        builder.addSlot(RecipeIngredientRole.OUTPUT, 168, 137).addItemStack(recipe.getResultItem(world.registryAccess()));
